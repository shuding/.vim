...
"                insert into your document using a trigger word followed by a "<enter>".
"
...
fun! TriggerSnippet()
	if exists('g:SuperTabMappingForward')
		if g:SuperTabMappingForward == "<enter>"
			let SuperTabKey = "\<c-n>"
		elseif g:SuperTabMappingBackward == "<enter>"
			let SuperTabKey = "\<c-p>"
		endif
	endif

	if pumvisible() " Update snippet if completion is used, or deal with superenter
		if exists('SuperTabKey')
			call feedkeys(SuperTabKey) | return ''
		endif
		call feedkeys("\<esc>a", 'n') " Close completion menu
		call feedkeys("\<enter>") | return ''
	endif
...
fun! BackwardsSnippet()
	...
	if exists('g:SuperTabMappingForward')
		if g:SuperTabMappingBackward == "<s-enter>"
			let SuperTabKey = "\<c-p>"
		elseif g:SuperTabMappingForward == "<s-enter>"
			let SuperTabKey = "\<c-n>"
		endif
	endif
	if exists('SuperTabKey')
